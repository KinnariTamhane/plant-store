...
function Product({plant,selectedItem}) {
  return (
    <div className='bg-[#9CE5CB] my-6 ml-4 mr-10 relative h-auto border rounded-3xl' onClick={selectedItem}>
        ...
        <img className='h-[180px] absolute right-[-50px] top-[-45px]' src={plant.image}/>
    </div>
  )
}
