...
function Product({plant,selectedPlant}) {
  return (
    <div className='bg-[#9CE5CB] my-6 ml-4 mr-10 relative h-auto border rounded-3xl mb-20' onClick={selectedPlant}>
        ...
        <img className='h-[180px] absolute right-[-50px] top-[-90px]' src={plant.image} alt={plant.name}/>
    </div>
  )
}
